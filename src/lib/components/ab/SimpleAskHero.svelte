		...
		<div class="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-center">
			...
			<div class="lg:col-span-7 flex flex-col gap-5 lg:gap-7">
				...
				<h1
					...
					style="opacity: 0;"
				>
					Before your next big meeting,<br />
					<span class="text-lavender italic">ask your chart.</span>
				</h1>
				...
				<p
					...
					style="opacity: 0;"
				>
					It knows things your calendar doesn't. Like which days you're most likely to close.
				</p>
				...
				<div data-reveal class="flex flex-wrap gap-2.5" style="opacity: 0;">
					<div class="feature-chip">
						<svg width="14" height="14" viewBox="0 0 14 14" fill="none" class="text-lavender">
							<path d="M7 1v12M1 7h12" stroke="currentColor" stroke-width="1" stroke-linecap="round"/>
							<circle cx="7" cy="7" r="5.5" stroke="currentColor" stroke-width="1"/>
						</svg>
						<span>Meeting prep insights</span>
					</div>
					<div class="feature-chip">
						<svg width="14" height="14" viewBox="0 0 14 14" fill="none" class="text-lavender">
							<path d="M2 10L5 4L8 7L12 2" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"/>
						</svg>
						<span>Close-rate days</span>
					</div>
					<div class="feature-chip">
						<svg width="14" height="14" viewBox="0 0 14 14" fill="none" class="text-lavender">
				...
				<!-- CTA -->
				<div data-reveal style="opacity: 0;">
					<EmailForm id="hero-waitlist" referralSource={utmSource || 'ab-simple-ask'} ctaText="Join the Waitlist — It's Free" />
				</div>
			</div>
