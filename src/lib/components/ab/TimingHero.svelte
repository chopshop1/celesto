<script lang="ts">
	...
	import AppDemo from '$lib/components/AppDemo.svelte';
		...
		<div class="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-center">
			...
			<div class="lg:col-span-7 flex flex-col gap-5 lg:gap-7">
				...
				<h1
					...
					style="opacity: 0;"
				>
					What if your timing<br class="hidden sm:block" />
					was always right?<br />
					<span class="text-lavender italic">Celesto shows you when.</span>
				</h1>
				...
				<p
					...
					style="opacity: 0;"
				>
					Your birth chart knows when your best windows open. Celesto tells you exactly when to make the move — career, love, money, conversations. Stop guessing. Start knowing.
				</p>
				...
				<div data-reveal class="flex flex-wrap gap-2.5" style="opacity: 0;">
					<div class="feature-chip">
						<svg width="14" height="14" viewBox="0 0 14 14" fill="none" class="text-lavender">
							...
							<line x1="7" y1="4" x2="7" y2="7" stroke="currentColor" stroke-width="1" stroke-linecap="round"/>
							<line x1="7" y1="7" x2="9.5" y2="8.5" stroke="currentColor" stroke-width="1" stroke-linecap="round"/>
						</svg>
					...
					<div class="feature-chip">
						...
						<span>Power day calendar</span>
					</div>
					<div class="feature-chip">
						<svg width="14" height="14" viewBox="0 0 14 14" fill="none" class="text-lavender">
							<path d="M2 7h2l2-4 2 8 2-5h2" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"/>
						</svg>
				...
				<!-- CTA -->
				<div data-reveal style="opacity: 0;">
					<EmailForm id="hero-waitlist" referralSource={utmSource || 'ab-timing'} ctaText="Join the Waitlist — It's Free" />
				</div>
			</div>
